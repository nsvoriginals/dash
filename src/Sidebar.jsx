  ...
  const getNameFromStorage = () => {
    try {
      ...
      if (resumeData) {
        ...
        return parsedData.basics?.name || "User Name";
      }
    ...
    <>
      ...
      `}>
            ...
            {menuItems.map((item) => (
              <li key={item}>
                <button
                  ...
                  className={`
                    w-full text-left py-3 my-2 px-6 
        ...
        <div className="p-4 border-t border-gray-700 " onClick={handleLogout}>
          <button className="w-full py-2 px-4 rounded-lg flex items-center space-x-3 hover:bg-gray-700 transition-colors">
            <svg
              xmlns="http://www.w3.org/2000/svg"
